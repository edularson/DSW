...
const produto3 = new Produto(3, "Camiseta Corinthians", 400);
const produto4 = new Produto(4, "Boné Corinthians", 100);

const venda1 = new Venda(1001, 11111111, cliente1, [produto1, produto2]);
const venda2 = new Venda(1002, 22222222, cliente2, [produto3, produto4]);
